...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    ';
        ...
        try {
            ...
            //Recipients
            $mail->CharSet = 'UTF-8';
            $mail->setFrom('nghiencofffe@gmail.com', 'Nghiện Coffee');                // Gửi mail tới Mail Server
            ...
            $mail->Subject = 'Xác nhận đơn hàng từ Nghiện Coffee';
            $mail->Body    = $str_body;
...
echo "<script>window.location.href = '/nghien/success.php'</script>";
?>