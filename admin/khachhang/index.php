                    ...
                    <tbody>
                      <?php foreach($product as $item) : ?>
                        <tr scope="row">
                            ...
                            <td> <a href="./edit_khachhang.php?id_khachhang=<?php echo $item['id_khachhang']?>"><i class="far fa-edit" style="font-size: 18px;"></a></td>
                            <td></i><a href="./delete_khachhang.php?id_khachhang=<?php echo $item['id_khachhang']?>"><i class="far fa-trash-alt" style="color: red;font-size: 20px;"></i></a></td>
                        </tr>
                      <?php endforeach ?>
                    </tbody>
                </table>
                      ...
                      <div class="test">
                        <button class="btn btn-gradient-primary mt-4" type="submit"><a href="./add_khachhang.php" class="card-description" style="color: white;font-weight: bold;">Thêm khách hàng</a></button>           
                      </div>
                  </div>
                </div>
              </div>
