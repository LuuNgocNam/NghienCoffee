                  ...
                  <div class="card-body">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col" style="color: black;">Mã sản phẩm</th>                           
                            <th scope="col" style="color: black;">Tên sản phẩm</th>                           
                            <th scope="col" style="color: black;">Hình ảnh</th>
                            <th scope="col" style="color: black;">Số lượng nhập</th>
                            <th scope="col" style="color: black;">Số lượng tồn</th>
                    ...
                    <tbody>
                      <?php foreach($product as $item) : ?>
                        <tr scope="row">
                            ...
                            <td> <a href="./edit_kho.php?id_kho=<?php echo $item['id_kho']?>"><i class="far fa-edit" style="font-size: 18px;"></a></td>
                            <td></i><a href="./delete_kho.php?id_kho=<?php echo $item['id_kho']?>"><i class="far fa-trash-alt" style="color: red;font-size: 20px;"></i></a></td>
                        </tr>
                      <?php endforeach ?>
                    </tbody>
                </table>
                      <div class="container" style="display: flex;">
                        <div class="test">
                          <button class="btn btn-gradient-primary mt-4" type="submit"><a href="./add_kho.php" class="card-description" style="color: white;font-weight: bold;">Thêm kho</a></button>   
                        </div>
                        <td colspan = 11>
                          <form action="exportdata.php" method="post">
                            <button class="btn btn-success  mb-2" style="margin-top: 19px; margin-left: 30px;" type="submit" name="export"><i class="fas fa-file-excel"></i> Export Excel</button>
                          </form>
                        </td>
                      </div>
                  </div>
