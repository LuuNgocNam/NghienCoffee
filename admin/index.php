...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql_prd  = "SELECT COUNT(*) as 'count' FROM `tbl_sanpham` WHERE 1;";
    ...
    // $sql_DoanhThu  = "SELECT SUM(tongtien) as 'count' FROM `tbl_hoadon`";
    $sql_Chart  = "SELECT SUM(tongtien) as 'count', DAY(ngay) as 'time' FROM `tbl_hoadon` GROUP BY DAY(ngay)";
            ...
            <div class="row">
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h4 class="font-weight-normal mb-3">Tài khoản <i class="mdi mdi-chart-line mdi-24px float-right"></i>
                    </h4>
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-info card-img-holder text-white">
                  <div class="card-body">
                    <img src="../public/site/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Sản Phẩm <i class="mdi mdi-bookmark-outline mdi-24px float-right"></i>
                    </h4>
