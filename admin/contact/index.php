                  ...
                  <div class="card-body">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col" style="color: black;">Đánh giá</th>
                    ...
                    <tbody>
                      <?php foreach($product as $item) : ?>
                        <tr scope="row">
                            ...
                            <td><?php echo $item['loinhac']?></td>
                            <td> <a href="./edit_contact.php?id_ct=<?php echo $item['id_ct']?>"><i class="far fa-edit" style="font-size: 18px;"></a></td>
                            <td></i><a href="./delete_contact.php?id_ct=<?php echo $item['id_ct']?>"><i class="far fa-trash-alt" style="color: red;font-size: 20px;"></i></a></td>
                        </tr>
                      <?php endforeach ?>
                    </tbody>
                </table>
                      ...
                      <div class="test">
                        <button class="btn btn-gradient-primary mt-4" type="submit"><a href="./add_contact.php" class="card-description" style="color: white;font-weight: bold;">Thêm liên hệ</a></button>           
                      </div>
                  </div>
                </div>
              </div>
