                  ...
                  <div class="card-body">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col" style="color: black;">Tên nhân viên</th>
                            <th scope="col" style="color: black;">Avatar</th>
                            <th scope="col" style="color: black;">Giới tính</th>                           
                            <th scope="col" style="color: black;">Chức vụ</th>
                    ...
                    <tbody>
                      <?php foreach($product as $item) : ?>
                        <tr scope="row">
                            ...
                            <td> <a href="./edit_nhanvien.php?id_nv=<?php echo $item['id_nv']?>"><i class="far fa-edit" style="font-size: 18px;"></a></td>
                            <td></i><a href="./delete_nhanvien.php?id_nv=<?php echo $item['id_nv']?>"><i class="far fa-trash-alt" style="color: red;font-size: 20px;"></i></a></td>
                        </tr>
                      <?php endforeach ?>
                    </tbody>
                </table>
                      ...
                      <div class="test">
                        <button class="btn btn-gradient-primary mt-4" type="submit"><a href="./add_nhanvien.php" class="card-description" style="color: white;font-weight: bold;">Thêm nhân viên</a></button>           
                      </div>
                  </div>
                </div>
              </div>
