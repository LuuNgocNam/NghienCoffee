      ...
      <div class="container">
        <div class="row d-flex">
          ...
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="blog-single.html" class="block-20" style="background-image: url(<?php echo $base_url.$item['hinhanh'] ?>);">
              </a>
              <div class="text py-4 d-block">
              	<div class="meta">
                  <div><a href="#"><?php echo $item['ngay'] ?></a></div>
                  <div><a href="#"><?php echo $item['tacgia'] ?></a></div>
                  <div><a href="#" class="meta-chat"><span class="icon-chat"></span> <?php echo $item['binhluan'] ?></a></div>
                </div>
                <h3 class="heading mt-2"><a href="#"><?php echo $item['tenbv'] ?></a></h3>
