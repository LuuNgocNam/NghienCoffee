        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
            	<h1 class="mb-3 mt-5 bread">Hoá đơn</h1>
	            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Trang chủ</a></span> <span>Hoá đơn</span></p>
            </div>
    			...
    			<div class="col-md-12 ftco-animate">
                  ...
                  <?php if(count($_SESSION['cart']) > 0) :?>
                    <?php foreach ($prd_cart as $key => $item) : ?>
                      <tr class="text-center">
                        <td class="product-remove"><a href="../modules/cart/delete_cart.php?id_sp=<?php echo $item['id_sp']?>"><span class="icon-close"></span></a></td>
                        
                        <td class="image-prod"><img width="100px" src="<?php echo $base_url . $item['hinhanh'] ?>" alt=""></td>
                        ...
                        <td class="price"><?php echo $item['gia'] ?>$</td>
                        
                        <td class="quantity">
                          <div class="input-group mb-3">
                            <input type="" name="quantity" class="quantity form-control input-number" value="<?php echo $_SESSION["cart"][$item['id_sp']] ?>">
                          </div>
                        </td>
                        <?php $total_price +=  $item['gia'] * $_SESSION["cart"][$item['id_sp']]?>
                        <td class="total"><?php echo $item['gia'] * $_SESSION["cart"][$item['id_sp']] ?>$</td>
                      </tr><!-- END TR-->
                    <?php endforeach ?> 
                  <?php endif ?>
						    </tbody>
