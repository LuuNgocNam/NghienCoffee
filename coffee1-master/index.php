  ...
  <body>
        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-8 col-sm-12 text-center ftco-animate">
              ...
              <p class="mb-4 mb-md-5">chúng tôi luôn sử dụng cà phê được bảo quản đủ 29 ngày sau khi rang để đảm bảo chất lượng tách cà phê tốt nhất.</p>
      ...
      <div class="slider-item" style="background-image: url(images/bg_2.jpg);">
        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-8 col-sm-12 text-center ftco-animate">
            	<span class="subheading">Chào mừng</span>
              <h1 class="mb-4">Hương vị tuyệt vời & amp; Địa điểm đẹp</h1>
              <p class="mb-4 mb-md-5">Vì trải nghiệm cà phê thăng hoa, hãy để những hạt cà được nghỉ ngơi và ủ hương bồi vị.</p>
      ...
      <div class="slider-item" style="background-image: url(images/bg_3.jpg);">
        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-8 col-sm-12 text-center ftco-animate">
            	<span class="subheading">Chào mừng</span>
              <h1 class="mb-4">Kem nóng và sẵn sàng để phục vụ</h1>
              <p class="mb-4 mb-md-5">Nghiện Coffe luôn sãn sàng và phục vụ quý khách mọi lúc mọi nơi hàng giờ.</p>
              <p><a href="#" class="btn btn-primary p-3 px-xl-4 py-xl-3">Order Now</a> <a href="#" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">View Menu</a></p>
            </div>
    ...
    <section class="ftco-about d-md-flex">
    	...
    	<div class="one-half ftco-animate">
	        ...
	        <div>
	  			<p>Trên đường đi, cô đã gặp một bản sao. Bản sao cảnh báo Văn bản Người mù nhỏ rằng nơi xuất phát của nó sẽ được viết lại hàng nghìn lần và mọi thứ còn lại từ nguồn gốc của nó sẽ là từ "và" và Văn bản Người mù nhỏ nên quay lại và trở lại như cũ, đất nước an toàn. Nhưng không có gì bản sao nói có thể thuyết phục cô ấy và vì vậy không mất nhiều thời gian cho đến khi một vài Copy Writers quỷ quyệt phục kích cô ấy, khiến cô ấy say xỉn với Longe và Parole và kéo cô ấy vào cơ quan của họ, nơi họ lạm dụng cô ấy vì họ.</p>
	  		</div>
  			</div>
    	</div>
    </section>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="media d-block text-center block-6 services">
              ...
              <div class="media-body">
                <h3 class="heading">DỄ DÀNG ĐẶT ĐỒ</h3>
                <p>Giúp chủ doanh nghiệp tiết kiệm thời gian, nhân lực trong việc quản lý vận hành thông qua việc kiểm soát chi tiết đơn hàng.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 ftco-animate">
            <div class="media d-block text-center block-6 services">
              ...
              <div class="media-body">
                ...
                <p>Với tiêu chuẩn vận chuyển nghiêm ngặt, Nghiện Coffee đảm bảo đơn hàng được giao đến trong trạng thái tốt nhất với chi phí hợp lý nhất.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 ftco-animate">
            <div class="media d-block text-center block-6 services">
              ...
              <div class="media-body">
                <h3 class="heading">HẠT CÀ PHÊ	</h3>
                <p>Các nhà rang cần phải cân nhắc, xem xét về việc lựa chọn loại hàng để cho ra sản phẩm tốt nhất</p>
              </div>
            </div>    
          </div>
        </div>
    ...
    <section class="ftco-section">
    	<div class="container">
    		<div class="row align-items-center">
	            ...
	            <p class="mb-4">Tùy vào concept cửa hàng của riêng mỗi người, mà menu mỗi quán lại có những sự khác nhau nhất định. Tuy nhiên, để tiếp cận khách hàng dễ dàng hơn, chúng ta cần những nhóm đồ uống “quen thuộc”, “an toàn” bên cạnh những đồ uống mới hiện đại hơn để khách hàng có đa dạng lựa chọn.</p>
